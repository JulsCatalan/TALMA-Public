        ...
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          >
            ...
            <div id="precios" className="scroll-mt-28">
              ...
              <SubHeading>Selección de plan y responsabilidad del Cliente.</SubHeading>
              <Para>El Cliente reconoce y acepta que la adecuada selección del plan es una obligación suya y que la prestación, capacidad y desempeño del Servicio dependen, entre otros factores, del plan contratado, del número de usuarios administradores habilitados y del volumen estimado de denuncias que se reciban a través del canal.</Para>
              <Para>En consecuencia, el Cliente se obliga a evaluar y seleccionar el plan que corresponda a sus necesidades operativas, considerando su estructura (número de sucursales, puntos de atención, usuarios potenciales) y la proyección de uso (estimación de denuncias por día y mes). Si el Cliente estima, o por su razón debería estimar, que el volumen de denuncias o el número de usuarios previstos excederán la capacidad de un plan inferior, deberá contratar un plan superior o notificar a Talma Tech para recibir asesoría sobre la configuración adecuada.</Para>
              <Para>Si el Cliente contrata un plan que resulte insuficiente para el volumen real de uso, podrá experimentar degradación del servicio, lentitud, errores o restricciones operativas. Talma Tech podrá, a su discreción razonable: (i) ofrecer alternativas técnicas o comerciales para restablecer el servicio, (ii) aplicar medidas de protección y limitación de recursos para preservar la estabilidad de la Plataforma, o (iii) suspender funciones que excedan las capacidades del plan contratado hasta que el Cliente subsane la situación mediante la contratación de un plan adecuado.</Para>
